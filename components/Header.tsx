      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <ScrollLink
            ...
            smooth={true}
            duration={500}
            className="relative z-10 left-3 cursor-pointer top-2.5 sm:left-0 sm:top-2.5 translate-y-2 lg:-translate-x-8 md:absolute lg:relative md:left-3"
          >
            <Image
              src="/rcmegalogo.png"
              alt="RC MEGA"
          ...
          {/* Desktop Navigation */}
          <nav
            className={`hidden z-10 md:flex space-x-8 ${neuroPolitical.className}`}
          >
            {navItems.map((item) => (
              <ScrollLink
                key={item.name}
          ...
          {isMenuOpen && (
            <>
              ...
              >
                ...
                <nav
                  className={`flex flex-col p-6 ${neuroPolitical.className}`}
                >
